...
class ModuleLayoutTests(unittest.TestCase):
    ...
    def test_pressure_module(self):
        from topogenesis.cognition.pressure import NeedPressure, ViabilityState
        needs = NeedPressure.from_viability(ViabilityState(energy=0.25))
        self.assertAlmostEqual(needs.metabolic, 0.75)
        self.assertEqual(needs.dominant, "metabolic")
